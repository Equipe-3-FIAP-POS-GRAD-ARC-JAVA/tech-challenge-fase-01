...
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Vinicius Padovam', 'vinicius@example.com', 'vpadovam', '$2a$10$5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5u', NOW(), NOW(), '{OWNER}', true) ON CONFLICT (email) DO NOTHING;

INSERT INTO "users" (id, name, email, login, password, created_at, updated_at, roles, is_active)
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'Maria Silva', 'maria.silva@example.com', 'mariasilva', '$2a$10$5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5u', NOW(), NOW(), '{CLIENT}', true) ON CONFLICT (email) DO NOTHING;

INSERT INTO "users" (id, name, email, login, password, created_at, updated_at, roles, is_active)
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a13', 'João Pereira', 'joao.pereira@example.com', 'joaop', '$2a$10$5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5u', NOW(), NOW(), '{CLIENT}', true) ON CONFLICT (email) DO NOTHING;

INSERT INTO "users" (id, name, email, login, password, created_at, updated_at, roles, is_active)
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14', 'Ana Souza', 'ana.souza@example.com', 'anasouza', '$2a$10$5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5u', NOW(), NOW(), '{CLIENT}', true) ON CONFLICT (email) DO NOTHING;

INSERT INTO "users" (id, name, email, login, password, created_at, updated_at, roles, is_active)
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', 'Carlos Oliveira', 'carlos.oliveira@example.com', 'carlosol', '$2a$10$5Z5Z5Z5Z5Z5Z5Z5Z5Z5Z5u', NOW(), NOW(), '{OWNER}', true) ON CONFLICT (email) DO NOTHING;

-- Adicionar o usuário joao.silva com senha123
INSERT INTO "users" (id, name, email, login, password, created_at, updated_at, roles, is_active)
VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a17', 'João Silva', 'joao.silva@example.com', 'joao.silva', '$2a$12$LQv3c1yqBWVHxkd0LQ1lqe.A5Jx9LC9lgIdSwCYs2YYs1UVwVJe/C', NOW(), NOW(), '{CLIENT}', true) ON CONFLICT (email) DO NOTHING;

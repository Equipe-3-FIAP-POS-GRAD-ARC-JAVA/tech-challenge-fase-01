...
public class User {
    ...
    private User(String id, String name, String email, String login, String password, LocalDateTime createdAt, LocalDateTime updatedAt, RolesEnum role, boolean isActive) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.login = login;

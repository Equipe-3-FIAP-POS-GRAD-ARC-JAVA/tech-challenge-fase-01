...
- **1 ADMIN**: Emerson Silva (acesso total)  - Login: emerson.silva | Senha: senha123
- **2 OWNERS**: Vinicius Padovam - Login: vpadovam | Senha: senha123, Carlos Oliveira - Login: carlosol | Senha: senha123 (proprietários)
- **4 CLIENTS**: Maria Silva - Login: mariasilva | Senha: senha123, João Pereira - Login: joaop | Senha: senha123, Ana Souza - Login: anasouza | Senha: senha123, João Silva - Login: joao.silva | Senha: senha123
...
![Arquitetura Hexagonal](docs/Hexagonal_Architecture.png )
...
![Modelo de Domínio](docs/Domain_Model_Classes.png )
...
![Sequência de Autenticação](docs/Authentication_Sequence.png )
...
![Schema do Banco](docs/Database_Schema.png )
...
![Arquitetura Completa](docs/Complete_Architecture_Overview.png )
...
![Fluxo de Endereços](docs/Address_Complete_Flow_Sequence.png )
...
![Estrutura de Pacotes](docs/Package_Structure_Complete.png )
...
- **Observability Stack**: Integração com Grafana
